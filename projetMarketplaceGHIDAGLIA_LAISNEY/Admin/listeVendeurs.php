  ...
  <script>
    $(document).click(function(){
      $(".valid").click(function(){
        ...
        if(name == "supprimervendeur"){
          $.ajax({
            url: "supprimerVendeur.php",
            type : 'POST',
            data : {
              vendeur_id: identifiant,
              nom: name,
            }
          });
        }
...
<body>
  ...
  <div class="annonce" style="display:flex;justify-content:center;margin:20px;margin-bottom:40px;">
    <div class=""style="text-align: center;">
      <h3 >Ajoutez des vendeurs à la liste : </h3></div>
      <div >
        <form action="ajouterVendeur.html" method="post" >
          <table >
            <tr>
          ...
          <table class="table" id="basictable">
            <thead>
              <tr>
                ...
                <th class="th-sm" style="width:1"%;>Photo Préférée
                </th>
                <th class="th-sm">Fond d'écran
                </th>
                <th class="th-sm">
                </th>
              </tr>
          ...
          //identifier votre BDD
            ...
            if ($db_found) {
              ...
              while ($data = mysqli_fetch_assoc($result)) {
                  ...
                  echo '<td><img src='. $data["photoPreferee"] .'></td>';
                  echo '<td><img src='. $data["backgroundPhoto"] .'></td>';
                  echo '<td><button class="valid" type="button" value="'.$data['idVendeur'].'" name="supprimervendeur">Supprimer</button></td>';
                  echo '</tr>';
                  echo '</tr>';
                }
            }
